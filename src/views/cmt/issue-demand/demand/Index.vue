  ...
  <div class="page-container user-index h-full">
    ...
    >
      <template #toolbar-left>
        <span class="mr-1 pl-1 text-[15px] font-bold">需求开发列表</span>
      </template>
    ...
    <DemandDetail v-model:open="detailOpen" :data="detailData" />
  </div>
</template>
...
import DemandDetail from "./components/DemandDetail.vue";
